...
b+=t(520,150,'3 mm acrylic')+t(520,188,'6 × Ø5.5 through holes')+t(520,226,'4 box screws: 117 × 116 hole pattern')+t(520,264,'2 arm screws: 154 centre spacing');
b+=t(520,318,'Coordinates from plate centre:')+t(520,347,'Box: (±58.5, ±58.0)')+t(520,376,'Arm: (0, ±77.0)')+t(520,418,'Rounded edges follow the design DXF.')+t(520,455,'Plate sits between box and arm underside.');
b+=t(75,551,'Original drawing notice: SOLIDWORKS Educational Product. For Instructional Use Only.','small');
await put('boxMount','B3 / External enclosure mounting plate','Millimetre design DXF · geometry-only CAD download available',b,625);
...
b+=t(510,125,'3 mm acrylic')+t(510,157,'Source units: inches; converted ×25.4')+t(510,202,'Camera cutout: 12.7 × 22.86')+t(510,234,'Camera holes: 4 × Ø2, pitch 21 × 12.5')+t(510,266,'Cable clearance: Ø31.75')+t(510,298,'Other cutouts: 10 × 10 and 10.16 × 7.62');
...
b+=t(75,763,'All 13 circular holes and all 3 rectangular cutouts retained. R3.81 outside corners.','small')+t(75,790,'Centre the plate in the lid; transfer port centres from the registered plate.','small');
...
b+=t(525,150,'EXTERIOR LID VIEW')+t(525,184,'Latch / camera edge shown at top')+t(525,224,'Camera: Ø22 at X75, Y116.032')+t(525,256,'Cable: Ø22 at X37.675, Y37.675')+t(525,293,'Datum: bottom-left of 150 × 150 envelope')+t(525,334,'Port locations derived from centred Pi plate.')+t(525,366,'Register the plate in the lid before drilling.')+t(525,412,'Camera port is the midpoint of the inner')+t(525,438,'camera bolt-hole pair, not the rectangle centre.');
...
await put('boxBody','B1 / Weatherproof enclosure body','Product envelope and added cable-access hole',body,520);
...
assembly+=t(470,95,'220 mm arm')+t(470,132,'3 mm outer acrylic mounting plate')+t(470,178,'90 mm enclosure height')+t(470,223,'Internal plate: 3 mm acrylic')+t(470,265,'Camera optical axis points down')+t(470,307,'Lens aligned above vane centre');
assembly+=t(100,410,'ASSEMBLED SIDE STACK · SPACING SCHEMATIC','small')+t(100,455,'Port and plate geometry use CAD; lid depth, pads and camera spacers remain approximate.','small')+t(100,485,'Adjust the upper arm in the stem slot to set camera height.','small');
...
for(const [id,title,sub,lines]of [
 ...
 ['boxScrews','B6 / Supplied enclosure mounting screws','Four screws included with purchased enclosure',['Quantity: 4','Hole pattern: 117 × 116','Acrylic clearance holes: Ø5.5','Use screws included with the enclosure']],
 ['cameraScrews','E3 / Camera mounting hardware','Four camera mounting points',['Quantity: 4 mounting locations','Plate holes: Ø2','Hole pattern: 21 × 12.5','M2 screws; M2.5 nuts and M2 washers as spacers']],
 ]){
