...
import { parameters as P, parts } from './data.js?v=c454cde96b62';
import { addPlatform } from './platform-model.js?v=c454cde96b62';
import {addEnclosure} from './enclosure-model.js?v=c454cde96b62';
...
export function createViewer(host, labelsHost, onSelect) {
  ...
  function setCamera(name='iso'){
    ...
    if(inside){const z=enclosure.inspect().centerZ;controls.target.set(0,360,z-35);camera.up.set(0,1,0);Object.assign(views,{iso:[200,165,z+310],front:[0,340,z+550],side:[570,390,z],top:[0,50,z-26]});if(name==='top')camera.up.set(0,0,-1);}
    if(inside&&!assemblies.enclosure){controls.target.set(0,322,55);Object.assign(views,{iso:[180,190,340],front:[0,322,375],side:[320,322,55],top:[0,20,55]});}
