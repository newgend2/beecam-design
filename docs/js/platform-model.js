...
import {panelShape,stopperShape,patternUV,vaneOutline} from './platform-shapes.js?v=9506fc6a12d4';

export function addPlatform({partGroup,mesh,bolt,addLabel}){
  const texture=new THREE.TextureLoader().load(new URL('../assets/contrast-pattern.svg?v=9506fc6a12d4',import.meta.url).href);
  texture.colorSpace=THREE.SRGBColorSpace;texture.anisotropy=8;
  const stopperTexture=new THREE.TextureLoader().load(new URL('../assets/stopper-contrast.svg?v=9506fc6a12d4',import.meta.url).href);
