...
import {panelShape,stopperShape,patternUV,vaneOutline} from './platform-shapes.js';
...
export function addPlatform({partGroup,mesh,bolt,addLabel}){
  ...
  const stopperTexture=new THREE.TextureLoader().load(new URL('../assets/stopper-contrast.svg',import.meta.url).href);
